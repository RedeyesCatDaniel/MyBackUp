...
using UnityEngine;
    ...
    [Serializable]
    public class SubsurfaceScatteringModel 
    {
        [Serializable]
        public struct Settings
        {
            ...
            public float[]        transmissionFlagsBuffer;         // 2 bit/profile; 0 = inf. thick, 1 = thin, 2 = regular
            ...
            public void UpdateCache()
            {
                ...
                if(transmissionFlagsBuffer == null || transmissionFlagsBuffer.Length != SssConstants.SSS_N_PROFILES)
                {
                    transmissionFlagsBuffer = new float[SssConstants.SSS_N_PROFILES];
                }
                ...
                for (int i = 0; i < numProfiles; i++)
                {
                    ...
                    transmissionFlagsBuffer[i] = (uint)profiles[i].transmissionMode;

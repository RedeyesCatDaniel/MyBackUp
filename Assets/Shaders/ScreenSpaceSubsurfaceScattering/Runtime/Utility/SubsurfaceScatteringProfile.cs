...
//namespace UnityEngine.PostProcessing
    ...
    public class SubsurfaceScatteringProfile : ScriptableObject
    {
        ...
        public enum TransmissionMode : uint { None = SssConstants.SSS_TRSM_MODE_NONE, ThinObject = SssConstants.SSS_TRSM_MODE_THIN, ThickObject };

        public bool m_UseDisney = true;
        ...
        {
            //int success = SubsurfaceScatteringRenderFeature.SetSSProfile(this);
    ...
    public class SubsurfaceScatteringProfileEditor : Editor
    {
        ...
        {
            public readonly GUIContent   sssProfilePreview0           = new GUIContent("Diffusion Profile Preview");
            ...
            public readonly GUIContent[] sssTransmissionModeOptions = new GUIContent[2]
            {
        ...
        private SerializedProperty m_ScatteringDistance, m_MaxRadius, m_ShapeParam, m_TransmissionTint,
                                    m_TexturingMode, m_TransmissionMode, m_ThicknessRemap, m_WorldScale, m_UseDisney;
        ...
        void OnEnable()
        {
            ...
            m_UseDisney           = serializedObject.FindProperty("m_UseDisney");
        ...
        public override void OnInspectorGUI()
        {
            ...
            bool useDisneySSS;
            {
                useDisneySSS = m_UseDisney.boolValue;
            }
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                EditorGUILayout.LabelField("Subsurface Scattering only", EditorStyles.boldLabel);
                ...
                EditorGUILayout.Space();
                EditorGUILayout.LabelField("Transmission only", EditorStyles.boldLabel);
                m_TransmissionMode.intValue = EditorGUILayout.Popup(styles.sssProfileTransmissionMode, m_TransmissionMode.intValue - 1, styles.sssTransmissionModeOptions) + 1;
            ...
            {
                (serializedObject.targetObject as SubsurfaceScatteringProfile).BuildKernel();
            }
        }
    }
#endif

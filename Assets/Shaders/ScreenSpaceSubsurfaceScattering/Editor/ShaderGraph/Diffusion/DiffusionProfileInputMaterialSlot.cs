...
namespace UnityEditor.Rendering.Universal//.ShaderGraph
{
    ...
    class DiffusionProfileInputMaterialSlot : Vector1MaterialSlot, IHasDependencies
    {
        ...
        {
            [SerializeField]
            public SubsurfaceScatteringProfile diffusionProfileAsset = null;
        }
        ...
        public override string GetDefaultValue(GenerationMode generationMode)
        {
            ...
            {
                return "((asuint(_DiffusionProfileHash) != 0) ? _DiffusionProfileHash : asfloat(uint(" + diffusionProfile.hash + ")))";
            }

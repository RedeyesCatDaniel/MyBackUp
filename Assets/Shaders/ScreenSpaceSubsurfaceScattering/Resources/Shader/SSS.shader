Shader "Hidden/Universal Render Pipeline/SSS"
{
    HLSLINCLUDE
...
#else
        //z = 1.0 - z;
        //half zc0 = _ZBufferParams.z * 2.0;
        //half zc1 = _ZBufferParams.w * 2.0 - 1.0;
        return 1.0 / (_ZBufferParams.z * z + _ZBufferParams.w);
    ...
    float4 Frag(Varyings input) : SV_Target
    {
        ...
        //half  centerDepth = SAMPLE_TEXTURE2D_X(_DepthTexture, sampler_DepthTexture, UnityStereoTransformScreenSpaceTex(centerPosition)).a ;
        ...
        //float centerDepth = SampleAndGetLinearDepth(UnityStereoTransformScreenSpaceTex(centerPosition));
        ...
        //[branch]
        //if (distScale < 1 || (maxDistInPixels < 10))
        //{
        //    #if SSS_DEBUG_LOD
        ...
        //    return float4((specular + centerIrradiance), 0);
        //    #endif
        //}
        ...
        else
        {
            ...
            float3 specular = SAMPLE_TEXTURE2D_X(_SSSSpecular, sampler_SSSSpecular, UnityStereoTransformScreenSpaceTex(centerPosition)).rgb;
            return float4(specular + (totalIrradiance / totalWeight), 1);

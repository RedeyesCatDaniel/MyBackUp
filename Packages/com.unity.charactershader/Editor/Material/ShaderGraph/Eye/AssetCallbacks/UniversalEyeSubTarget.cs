...
{
    sealed class UniversalEyeSubTarget : UniversalSubTarget
    {
        static readonly GUID kSourceCodeGuid = new GUID("94244d99da1257841bb48776559f0954"); // EyeShaderGraphTarget.cs
        ...
        public UniversalEyeSubTarget() => displayName = "Eye";
...
*/
        ...
        public override void Setup(ref TargetSetupContext context)
        {
            ...
            // Process SubShaders
            context.AddSubShader(PostProcessSubShader(SubShaders.LitComputeDotsSubShader(target, workflowMode, target.renderType, target.renderQueue, false)));
            context.AddSubShader(PostProcessSubShader(SubShaders.LitGLESSubShader(target, workflowMode, target.renderType, target.renderQueue, false)));
        }
        ...
        public override void GetActiveBlocks(ref TargetActiveBlockContext context)
        {
            ...
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.EyeMask);
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.EyeSpecularOcclusion);
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.EyeIrisNormal);
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.EyeAOColor);
...
*/
        ...
        static class LitIncludes
        {
            ...
            const string kForwardPass       = "Packages/com.unity.charactershader/Editor/Material/ShaderGraph/Eye/Includes/EyePBRForwardPass.hlsl";

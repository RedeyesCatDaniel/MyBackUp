...
{
    sealed class UniversalSkinSubTarget : UniversalSubTarget 
    {
        static readonly GUID kSourceCodeGuid = new GUID("ae5e8a5903d26624699fafd8f4a4218c"); // UniversalSkinSubTarget.cs
        ...
        private bool complexLit
        {
            get
            {
                ...
                return DualSpecularLobe; // && <complex feature>
            }
        }
        ...
        public override void GetFields(ref TargetFieldContext context)
        {
            ...
            // Template Predicates
            //context.AddField(UniversalFields.PredicateDualSpecularLobe, DualSpecularLobe);
        }
        ...
        public override void GetActiveBlocks(ref TargetActiveBlockContext context)
        {
            ...
            // Skin blocks
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.SkinScatteringColor);
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.SkinSubsurfaceMask);
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.SkinThickness);
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.SkinTransmission);
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.SkinLobeMix,         DualSpecularLobe );
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.SkinSmoothnessB,     DualSpecularLobe );
            context.AddBlock(CharacterShaderBlockFields.SurfaceDescription.SkinLookUpTexture);
        }
        ...
        public override void GetPropertiesGUI(ref TargetPropertyGUIContext context, Action onChange, Action<String> registerUndo)
        {
            ...
            context.AddProperty("Dual Specular Lobe", new Toggle() { value = DualSpecularLobe }, (evt) =>
            {
                if (Equals(DualSpecularLobe, evt.newValue))
                    return;

                registerUndo("Change Dual Specular Lobe");
                DualSpecularLobe = evt.newValue;
                onChange();
            });
        }
        ...
        static class LitPasses
        {
                ...
                PragmaCollection pragmas)
            {
                ...
                if (complexLit)
                    result.defines.Add(LitDefines.DualSpecularLobe, 1);
        ...
        static class LitBlockMasks
        {
            ...
            public static readonly BlockFieldDescriptor[] FragmentComplexLit = new BlockFieldDescriptor[]
            {
                ...
                CharacterShaderBlockFields.SurfaceDescription.SkinSubsurfaceMask,
                CharacterShaderBlockFields.SurfaceDescription.SkinThickness,
                CharacterShaderBlockFields.SurfaceDescription.SkinLobeMix,
                CharacterShaderBlockFields.SurfaceDescription.SkinSmoothnessB,
                CharacterShaderBlockFields.SurfaceDescription.SkinTransmission,
            };
        ...
        {
            public static readonly KeywordDescriptor DualSpecularLobe = new KeywordDescriptor()
            {
                displayName = "Dual Specular Lobe",
                referenceName = "_DUAL_SPECULAR_LOBE 1",
        ...
        static class LitIncludes
        {
            ...
            // Custom Skin Pass
            const string kForwardPass       = "Packages/com.unity.charactershader/Editor/Material/ShaderGraph/Skin/Includes/SkinForwardPass.hlsl";
            const string kSkinSurfaceData   = "Packages/com.unity.charactershader/Editor/Material/ShaderGraph/Skin/Includes/SkinSurfaceData.hlsl";
            const string kSkinLighting      = "Packages/com.unity.charactershader/Editor/Material/ShaderGraph/Skin/Includes/SkinLighting.hlsl";
            const string kSubsurfaceScatter = "Packages/com.unity.charactershader/Editor/Material/ShaderGraph/Skin/Includes/SubsurfaceScattering.hlsl";
            ...
            public static readonly IncludeCollection Forward = new IncludeCollection
            {
                ...
                { kSkinSurfaceData, IncludeLocation.Postgraph },
                { kSubsurfaceScatter, IncludeLocation.Postgraph },
                { kSkinLighting, IncludeLocation.Postgraph },

...
namespace UnityEngine.Rendering.Universal
{
    ...
    [HelpURL("https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@" + "latest/index.html?subfolder=/manual/" + "Diffusion -Profile" + ".html")]
    internal partial class DiffusionProfileSettings : ScriptableObject
    {
        ...
        void OnEnable()
        {
            ...
            // This is for upgrade diffusion from old format
/*
#if UNITY_EDITOR
            ...
            UnityEditor.Rendering.Universal.DiffusionProfileHashTable.UpdateDiffusionProfileHashNow(this);
#endif
*/
        }
